...
class _BotCommands:
    def __init__(self):
        ...
        self.UnzipMirrorCommand = [f'unzipmirror1{CMD_SUFFIX}', f'uzm1{CMD_SUFFIX}']
        ...
        self.QbUnzipMirrorCommand = [f'qbunzipmirror1{CMD_SUFFIX}', f'quzm1{CMD_SUFFIX}']
        self.QbZipMirrorCommand = [f'qbzipmirror1{CMD_SUFFIX}', f'qzm1{CMD_SUFFIX}']
        ...
        self.UnzipLeechCommand = [f'unzipleech1{CMD_SUFFIX}', f'uzl1{CMD_SUFFIX}']
        self.ZipLeechCommand = [f'zipleech1{CMD_SUFFIX}', f'zl1{CMD_SUFFIX}']
        self.QbLeechCommand = [f'qbleech1{CMD_SUFFIX}', f'ql1{CMD_SUFFIX}']
        self.QbUnzipLeechCommand = [f'qbunzipleech1{CMD_SUFFIX}', f'quzl1{CMD_SUFFIX}']
        self.QbZipLeechCommand = [f'qbzipleech1{CMD_SUFFIX}', f'qzl1{CMD_SUFFIX}']
        self.YtdlLeechCommand = [f'ytdlleech1{CMD_SUFFIX}', f'yl1{CMD_SUFFIX}']
        self.YtdlZipLeechCommand = [f'ytdlzipleech1{CMD_SUFFIX}', f'yzl1{CMD_SUFFIX}']
        ...
        self.CancelAllCommand = [f'cancelall1{CMD_SUFFIX}', 'cancelallbot']
